...
describe Bosh::Agent::Platform::Linux::DiskManager do
  ...
  subject(:disk_manager) { Bosh::Agent::Platform::Linux::DiskManager.new }
  ...
  before { stub_const('Bosh::Agent::Platform::Linux::DiskManager::DEV_PATH_TIMEOUT', 0) }
  before { stub_const('Bosh::Agent::Platform::Linux::DiskManager::DISK_RETRY_MAX_DEFAULT', 2) }
